    ...
    <div class="ui column">
        <div style="background-color: #e5ecf3; padding: 0">
            ...
            <div class="row border-bottom-paperviu-sky">
                ...
                <h1 class="ui header text-paperviu-d7 hover-text-paperviu-sky"
                    style="padding-left: 10px; margin-top: 0">{{titulo}}</h1>
...
<script>
    ...
    export default {
        ...
        props: ['id', 'titulo', 'fecha', 'tipo', 'empresa', 'valoracion', 'imagen', 'estado', 'estadoAdmin'],
        mounted() {
